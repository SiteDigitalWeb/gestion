  ...
  <div class="col-md-12">
   <div class="block">
    ...
    <div class="block-title">
     ...
     <h2><strong>Crear</strong> sector</h2>
    </div>
    
    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('ge/sector'))) }}


    <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Sector</label>
      <div class="col-md-9">
       {{Form::text('sector', '', array('class' => 'form-control','placeholder'=>'Ingrese sector'))}}
      </div>
    </div>
