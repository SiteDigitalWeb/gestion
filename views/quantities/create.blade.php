...
<div class="content-header">
 <ul class="nav-horizontal text-center">
  ...
  <li>
   ...
   <li>
   <a href="/ge/quantities"><i class="fa fa-list-ul"></i>Cantidades</a>
  </li>
  ...
  <div class="col-md-12">
   <div class="block">
    ...
    <div class="block-title">
     ...
     <h2><strong>Crear</strong> cantidad</h2>
    </div>
    
    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('ge/quantities'))) }}
