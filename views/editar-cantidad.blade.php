 ...
 <div class="row">
  <div class="col-md-12">
   <div class="block">
    ...
    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/comercial/editarcantidad',Request::segment(4)))) }}


    <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Cantidad empleados</label>
      <div class="col-md-9">
       {{Form::text('cantidad', $cantidad->cantidad, array('class' => 'form-control','placeholder'=>'Ingrese cantidad'))}}
      </div>
    </div>
