  ...
  <div class="col-md-12">
   <div class="block">
    ...
    <div class="block-title">
     ...
     <h2><strong>Crear</strong> motivo</h2>
    </div>
    
    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/registrar/motivo'))) }}


    <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Motivo</label>
      <div class="col-md-9">
       {{Form::text('motivo', '', array('class' => 'form-control','placeholder'=>'Ingrese motivo'))}}
      </div>
    </div>
