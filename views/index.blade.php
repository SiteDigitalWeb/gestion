...
<div class="content-header">
 <ul class="nav-horizontal text-center">
  ...
  <li>
   <a href="/ge/products"><i class="fa fa-file-o"></i>Productos & Servicios</a>
  </li>
  <li>
   <a href="/ge/sectors"><i class="fa fa-file-o"></i>Sectores</a>
  </li>
  <li>
   <a href="/ge/referrals"><i class="fa fa-file-o"></i>Referidos</a>
  </li>
   <li class="">
   <a href="/gestion/comercial/cantidades"><i class="fa fa-file-o"></i>Cantidades</a>
  </li>
  <li class="">
   <a href="/ge/embudo"><i class="fa fa-file-o"></i>Embudos</a>
  </li>
 </ul>
</div>
