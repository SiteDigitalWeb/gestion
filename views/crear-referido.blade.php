 ...
 <div class="row">
  <div class="col-md-12">
   <div class="block">
    ...
    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/registrar/referido'))) }}


    <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Referido</label>
      <div class="col-md-9">
       {{Form::text('referido', '', array('class' => 'form-control','placeholder'=>'Ingrese referido'))}}
      </div>
    </div>
