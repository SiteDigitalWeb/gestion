...
<div class="container">
 <div class="container-fluid">
  <a href="/ge/create-embudo" class="btn btn-primary pull-right">Crear Funel</a>
 </div>
 <br>
    ...
    <tbody>
     @foreach($funels as $funels)
      <tr>
       ...
       <td class="text-center"><a href="<?=URL::to('gestion/comercial/editar-funels');?>/{{$funels->id}}"><span  id="tip" data-toggle="tooltip" data-placement="left" title="Editar cantidad" class="btn btn-primary"><i class="fa fa-pencil-square-o sidebar-nav-icon"></i></span></a>
       <script language="JavaScript">
		function confirmar ( mensaje ) {
		return confirm( mensaje );}
	   </script>
       <a href="<?=URL::to('gestion/comercial/eliminar-funels/');?>/{{$funels->id}}" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')"><span id="tup" data-toggle="tooltip" data-placement="right" title="Eliminar Funel" class="btn btn-danger"><i class="hi hi-trash sidebar-nav-icon"></i></span></a>
       </td>
      </tr>
     @endforeach
    </tbody>
