 ...
 <div class="row">
  <div class="col-md-12">
   <div class="block">
    ...
    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/comercial/editarfunel',Request::segment(4)))) }}

      <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Funel</label>
      <div class="col-md-9">
       {{Form::text('funel', $funels->funel, array('class' => 'form-control','placeholder'=>'Ingrese Funel'))}}
      </div>
    </div>
    ...
    <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Color</label>
      <div class="col-md-9">
       {{Form::color('color', $funels->color, array('class' => 'form-control','placeholder'=>'Ingrese Funel'))}}
      </div>
    </div>
