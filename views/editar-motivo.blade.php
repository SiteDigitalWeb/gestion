 ...
 <div class="row">
  <div class="col-md-12">
   <div class="block">
    ...
    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/comercial/editarmotivo',Request::segment(4)))) }}


    <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Motivo</label>
      <div class="col-md-9">
       {{Form::text('motivo', $motivo->motivo, array('class' => 'form-control','placeholder'=>'Ingrese motivo'))}}
      </div>
    </div>
