 ...
 <div class="row">
  <div class="col-md-12">
   <div class="block">
    ...
    @foreach($referido as $referido)


       {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/comercial/editarreferido',Request::segment(4)))) }}



    <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Referido</label>
      <div class="col-md-9">
       {{Form::text('referido', $referido->referidos, array('class' => 'form-control','placeholder'=>'Ingrese referido'))}}
      </div>
    </div>
