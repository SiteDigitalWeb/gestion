...
<div class="content-header">
 <ul class="nav-horizontal text-center">
  ...
  <li><a href="/gestion/comercial/registro"><i class="fa fa-user-plus"></i> Registrar Datos Usuario</a></li>
  ...
  <li class="active"><a href="/gestion/comercial/referidos"><i class="fa fa-file-o"></i>Referidos</a></li>
  ...
  <div class="col-md-12">
   <div class="block">
    ...
    <div class="block-title">
     <h2><strong>Editar</strong> referido</h2>
    </div>

    {{-- Formulario de edición --}}
    {{ Form::model($referido, [
        'route' => ['ge.referrals.update', $referido->id],
        'method' => 'PUT',
    ...
    <div class="form-group">
     <label class="col-md-3 control-label">Referido</label>
      <div class="col-md-9">
       {{-- Ajusta "referido" o "referidos" según el nombre de tu columna en la BD --}}
       {{ Form::text('referidos', null, ['class' => 'form-control','placeholder'=>'Ingrese referido']) }}
      </div>
    </div>
