 ...
 <div class="row">
  <div class="col-md-12">
   <div class="block">
    ...
    {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('ge/commercial'))) }}
    ...
    <div class="form-group">
     <label class="col-md-3 control-label" for="example-email-input">Fecha Inicio</label>
       <div class="col-md-9 date" id="datetimepicker7">
        {{Form::date('fecha','', array('class' => 'form-control','placeholder'=>'Ingrese fecha inicio'))}}
       </div>
    </div>
